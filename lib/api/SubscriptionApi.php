...
class SubscriptionApi
{
    ...
    {
        list($response) = $this->checkSubscriptionWithHttpInfo();
        return $response;
    }
     ...
     */
    public function checkSubscriptionAsync()
    {
        return $this->checkSubscriptionAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function checkSubscriptionRequest()
    {
