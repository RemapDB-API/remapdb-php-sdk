...
class SearchApi
{
    ...
    {
        list($response) = $this->searchWithHttpInfo($query, $accept_language);
        return $response;
    }
     ...
     */
    public function searchAsync($query, $accept_language = null)
    {
        return $this->searchAsyncWithHttpInfo($query, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function searchRequest($query, $accept_language = null)
    {
